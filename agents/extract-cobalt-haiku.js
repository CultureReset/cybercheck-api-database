#!/usr/bin/env node
/**
 * Extract ALL data from Cobalt's raw.json using Claude Haiku
 * Gets menus, hours, events, contact, reviews, specials, everything
 *
 * Run:
 *   node agents/extract-cobalt-haiku.js
 */
...
const OUT_FILE = path.join(__dirname, `../scraped-menus/${COBALT_SLUG}/extracted.json`);
...
async function extractCobalt() {
  console.log('\n🔍 Extracting: Cobalt, The Restaurant');
