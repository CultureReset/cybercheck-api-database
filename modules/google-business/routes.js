...
// Token encryption lives in core/crypto; it prefers OAUTH_TOKEN_ENCRYPTION_KEY
// and falls back to CREDENTIAL_ENCRYPTION_KEY / STRIPE_KEY_ENCRYPTION_KEY.
const { encryptToken, decryptToken } = require('../../core/crypto');
