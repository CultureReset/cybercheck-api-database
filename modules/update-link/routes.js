...
const mainDb = require('../../core/db'); // main Supabase — businesses/menu_items/specials/events
...
const { extractJsonFromImage } = require('../../core/ai');
...
router.get('/:token/vision-providers', validateToken, (req, res) => {
    const { getVisionProvidersStatus } = require('../../core/ai');
