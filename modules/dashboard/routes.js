...
const { resolveEntityId } = require('../../core/entity-resolver');
const menuGcr = require('../../core/menu-gcr');
const { extractJsonFromImage, getVisionProvidersStatus } = require('../../core/ai');
const gcr = () => getGcrDb();
...
async function sendBookingConfirmations(booking, siteId) {
    try {
        const { sendSms, fillTemplate, buildTemplateData } = require('../../core/sms');
...
router.post('/sms/campaign', async (req, res) => {
    ...
    const { sendSms, fillTemplate } = require('../../core/sms');
...
router.post('/resend-confirmation', async (req, res) => {
    ...
    try {
        const { sendSms, fillTemplate, buildTemplateData } = require('../../core/sms');
        const { sendEmail, customerConfirmationHtml, generateIcsContent } = require('../../core/email');
